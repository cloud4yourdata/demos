...
$containerName = "demo-labs-hive-llap"

$clusterType = "InteractiveHive"

$clusterName = "demo-labs-hive-llap"    # As a best practice, have the same name for the cluster and container
...
#ADL Credentials
$certificateFilePath = "d:\\Repos\\Cloud4YourData\\Demos\\DC201809\\MDMSecurityPrinciple.p12"
